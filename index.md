...
[`? nerfplus::interpret_nerfplus`](https://tiffanymtang.github.io/nerfplus/reference/interpret_nerfplus.md)
for details).
...
![](reference/figures/README-predict-plot-1.png)
...
The Shiny App can be launched directly from R via the
...
function to compute the interpretability results first, and then launch
the Shiny App with these results as arguments to
[`run_app()`](https://tiffanymtang.github.io/nerfplus/reference/run_app.md).
For example:
