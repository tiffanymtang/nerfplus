...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = file.path("nerfplus", "man", "figures", "README-")
)
```
...
1. An R package `nerfplus` to run NeRF+ on your own data (see [nerfplus/](nerfplus/))
2. All code necessary to reproduce the analysis and figures in [Tang et al. (2025)](https://arxiv.org/abs/2509.15611) (see [nerfplus-manuscript/](nerfplus-manuscript/))
